      ...
      {        
        ...
        if (MASTERswitchSTATE == 0) 
        ...
        else if (MASTERswitchSTATE == 1)
          {
            ...
            while (totalTestCounter < totalTests)
              {   
                Z_Coord_Sender(coord_arr[totalTestCounter]);

              //isActive = digitalRead(trigger);
                //Serial.print("Sending XY coordinate\t"); Serial.print(); Serial.println(i+1);
                delay(1000);
                if (xyTrigger == HIGH){
